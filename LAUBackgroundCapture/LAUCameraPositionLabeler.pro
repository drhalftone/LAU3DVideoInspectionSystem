# ============================================================================
# LAUBackgroundFilterNIR - Camera Labeling Tool (RAW NIR Video Mode)
# ============================================================================
...
# Enable RAW_NIR_VIDEO mode for camera labeling
...
# Require administrator privileges on Windows (needed to program camera labels and write systemConfig.ini)
win32:QMAKE_LFLAGS += /MANIFESTUAC:\"level=\'requireAdministrator\' uiAccess=\'false\'\"

# Version information
VERSION = 1.0.0
TARGET = LAUCameraPositionLabeler
win32:QMAKE_TARGET_PRODUCT = "Camera Position Labeler"
win32:QMAKE_TARGET_DESCRIPTION = "Camera Position Labeling Tool"
