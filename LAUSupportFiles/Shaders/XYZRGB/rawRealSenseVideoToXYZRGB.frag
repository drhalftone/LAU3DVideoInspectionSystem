...
void main()
{
    ...
    if (int(gl_FragCoord.x)%2 == 0){
        ...
        qt_fragColor.rgb = (qt_fragColor.rgb * qt_fragColor.a) / qt_fragColor.a * (qt_fragColor.a / qt_fragColor.a);
    } else {
        // PASS THROUGH THE RGB TEXTURE
        qt_fragColor = texelFetch(qt_colorTexture, textureCoordinate, 0);
    }
}
