...
void main()
{
    ...
    float phase = texelFetch(qt_depthTexture, ivec2(col, textureCoordinate.y), 0)[chn];
    ...
    qt_fragColor.a = texelFetch(qt_colorTexture, textureCoordinate, 0).r * qt_scaleFactor;
    // qt_fragColor.x = vecEFGH.z;
    // qt_fragColor.y = vecEFGH.w;
    // qt_fragColor.z = vecEFGH.x;
}
